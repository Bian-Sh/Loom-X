...
public sealed class ReleaseNotesViewContractTests
{
    ...
    public void 共享视图使用LiveMarkdown且只有一个滚动正文区()
    {
        ...
        Assert.Contains("<md:MarkdownRenderer MarkdownBuilder=\"{Binding Markdown}\"", source, StringComparison.Ordinal);
        ...
        Assert.Contains("Foreground=\"{DynamicResource TextSecondaryBrush}\"", source, StringComparison.Ordinal);
