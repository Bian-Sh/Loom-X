...
public sealed class OpenAiCompatibleModelClientTests
{
    ...
    {
        var sse = string.Join('\n',
            """data: {"choices":[{"delta":{"tool_calls":[{"index":0,"id":"call_1","function":{"name":"assistant_ask_user","arguments":"{\"title\":"}}]},"finish_reason":null}]}""",
            "",
            """data: {"choices":[{"delta":{"tool_calls":[{"index":1,"function":{"arguments":"\"测试面板\"}"}}]},"finish_reason":null}]}""",
            "",
            """data: {"choices":[{"delta":{},"finish_reason":"tool_calls"}]}""",
            "",
            "data: [DONE]",
